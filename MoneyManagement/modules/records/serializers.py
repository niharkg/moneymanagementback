...
from .models import Company, TokenDetail, PressRelease, CompanyMember, Document, Whitelist, InvestRecord
...
class ListInvestRecordSerializer(serializers.ModelSerializer):
	investor = BasicInvestorUserSerializer()
	transaction = FullTransactionSerializer()

	class Meta:
		model = InvestRecord
		fields = ('investor', 'transaction', 'created')
