...
from .models import Company, CompanyMember, PressRelease, TokenDetail, Document, Whitelist, InvestRecord
...
@admin.register(InvestRecord)
class InvestRecordAdmin(admin.ModelAdmin):
	list_display = ('id', 'investor', 'company', 'created')
	search_fields = ('investor__first_name', 'company__name')
	ordering = ('created',)

	# Detail Page Settings
	fieldsets = (
		('Company Info', {'fields': ('company',)}),
		('Investor Info', {'fields': ('investor_user',)}),
