...
class InvestRecord(models.Model):
	...
	Invest Record model
	"""
	investor = models.ForeignKey('users.InvestorUser', related_name='invest_records', on_delete=models.PROTECT)
	company = models.ForeignKey('Company', related_name='company_invest_records', on_delete=models.PROTECT)
	...
	class Meta:
		verbose_name_plural = '7. Invest Record'
		ordering = ['-created']

	def __str__(self):
		return self.company.name + ' ' + self.investor.full_name
